...
2. 📂 **Open the STM32CubeIDE project** corresponding to the implementation approach included in the repository to view the low-level (LL) ADC/relay control code.
